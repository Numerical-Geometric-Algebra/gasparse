...
typedef enum {gen_MultivectorTypeMIN = -1,gen_MultivectorType_dense,gen_MultivectorType_blades,gen_MultivectorTypeMAX} gen_MultivectorType;
...
typedef struct _gen0_GradesBitmap{
    static int bitmap0[1];
    static int bitmap1[3];
    static int bitmap2[3];
    static int bitmap3[1];
}gen0_GradesBitmap;
...
static gen0_DenseGradeProject_func gendenseproject = {
...
static gen0_BladesMultivector blades0_init(int *bitmap, ga_float *value, Py_ssize_t size, PyAlgebraObject *ga){
    ...
    for(Py_ssize_t i = 0; i < size; i++){
        switch(GRADE(bitmap[i])){
            case 0:
                blades.value0[grades_position[bitmap[i]]] += value[i];
                break;
            case 1:
                blades.value1[grades_position[bitmap[i]]] += value[i];
                break;
            case 2:
                blades.value2[grades_position[bitmap[i]]] += value[i];
                break;
            case 3:
                blades.value3[grades_position[bitmap[i]]] += value[i];
                break;
            default:
                return blades; // raise error
        }
...
PyMultivectorObject *binary_dense0_product(PyMultivectorObject *data0, PyMultivectorObject *data1,ProductType ptype){
    gen0_BladesMultivector *pdense0 = (gen0_BladesMultivector*)data0->data;
    gen0_BladesMultivector *pdense1 = (gen0_BladesMultivector*)data1->data;
    gen0_BladesMultivector *pdense  = (gen0_BladesMultivector*)PyMem_RawMalloc(sizeof(gen0_BladesMultivector));
...
PyMultivectorObject *binary_blades0_product(PyMultivectorObject *data0, PyMultivectorObject *data1,ProductType ptype){
    gen0_Multivector *pblades0 = (gen0_Multivector*)data0->data;
    gen0_Multivector *pblades1 = (gen0_Multivector*)data1->data;
    gen0_Multivector *pblades  = (gen0_Multivector*)PyMem_RawMalloc(sizeof(gen0_Multivector));
    PyMultivectorObject *out = init_multivector(data0,-1);
...
PyMultivectorObject *ternary_dense0_product(PyMultivectorObject *data0, PyMultivectorObject *data1, PyMultivectorObject *data2,ProductType ptype){
    gen0_BladesMultivector *pdense0 = (gen0_BladesMultivector*)data0->data;
    gen0_BladesMultivector *pdense1 = (gen0_BladesMultivector*)data1->data;
    gen0_BladesMultivector *pdense2 = (gen0_BladesMultivector*)data2->data;
    gen0_BladesMultivector *pdense  = (gen0_BladesMultivector*)PyMem_RawMalloc(sizeof(gen0_BladesMultivector));
    PyMultivectorObject *out = init_multivector(data0,-1);
...
PyMultivectorObject *ternary_blades0_product(PyMultivectorObject *data0, PyMultivectorObject *data1, PyMultivectorObject *data2,ProductType ptype){
    gen0_Multivector *pblades0 = (gen0_Multivector*)data0->data;
    gen0_Multivector *pblades1 = (gen0_Multivector*)data1->data;
    gen0_Multivector *pblades2 = (gen0_Multivector*)data2->data;
    gen0_Multivector *pblades  = (gen0_Multivector*)PyMem_RawMalloc(sizeof(gen0_Multivector));
    PyMultivectorObject *out = init_multivector(data0,-1);
...
PyMultivectorObject *binary_dense0_scalarproduct(PyMultivectorObject *self, ga_float value){
    PyMultivectorObject *out = init_multivector(self,-1);
    gen0_DenseMultivector *pdense0 = (gen0_DenseMultivector*)self->data;
    gen0_DenseMultivector *pdense = (gen0_DenseMultivector*)PyMem_RawMalloc(sizeof(gen0_DenseMultivector));
    if(!out || !pdense0 || !pdense){
...
PyMultivectorObject *binary_blades0_scalarproduct(PyMultivectorObject *self, ga_float value){
    PyMultivectorObject *out = init_multivector(self,-1);
    gen0_BladesMultivector *pblades0 = (gen0_BladesMultivector*)self->data;
    gen0_BladesMultivector *pblades = (gen0_BladesMultivector*)PyMem_RawMalloc(sizeof(gen0_BladesMultivector));
    if(!out || !pblades0 || !pblades){
...
PyMultivectorObject *binary_dense0_scalaradd(PyMultivectorObject *self, ga_float value, int sign){
    PyMultivectorObject *out = init_multivector(self,-1);
    gen0_DenseMultivector *pdense0 = (gen0_DenseMultivector*)self->data;
    gen0_DenseMultivector *pdense = (gen0_DenseMultivector*)PyMem_RawMalloc(sizeof(gen0_DenseMultivector));
    if(!out || !pdense0 || !pdense){
...
PyMultivectorObject *binary_blades0_scalaradd(PyMultivectorObject *self, ga_float value, int sign){
    PyMultivectorObject *out = init_multivector(self,-1);
    gen0_BladesMultivector *pblades0 = (gen0_BladesMultivector*)self->data;
    gen0_BladesMultivector *pblades = (gen0_BladesMultivector*)PyMem_RawMalloc(sizeof(gen0_BladesMultivector));
    if(!out || !pblades0 || !pblades){
...
PyMultivectorObject *unary_dense0_reverse(PyMultivectorObject *self){
    PyMultivectorObject *out = init_multivector(self,-1);
    gen0_DenseMultivector *pdense0 = (gen0_DenseMultivector*)self->data;
    gen0_DenseMultivector *pdense = (gen0_DenseMultivector*)PyMem_RawMalloc(sizeof(gen0_DenseMultivector));
    if(!out || !pdense0 || !pdense){
...
PyMultivectorObject *unary_blades0_reverse(PyMultivectorObject *self){
    PyMultivectorObject *out = init_multivector(self,-1);
    gen0_BladesMultivector *pblades0 = (gen0_BladesMultivector*)self->data;
    gen0_BladesMultivector *pblades = (gen0_BladesMultivector*)PyMem_RawMalloc(sizeof(gen0_BladesMultivector));
    if(!out || !pblades0 || !pblades){
...
gen_MathFuncs gen0_math_funcs = {
    .atomic_add[gen_MultivectorType_dense] = (gaatomicfunc) atomic_dense0_add,
    .atomic_product[gen_MultivectorType_dense] = (gaatomicprodfunc) atomic_dense0_product,
    .add[gen_MultivectorType_dense] = (gaaddfunc) binary_dense0_add,
    .product[gen_MultivectorType_dense] = (gaprodfunc) binary_dense0_product,
    .grade_project[gen_MultivectorType_dense] = (gaunarygradefunc) unary_dense0_gradeproject,
    .scalar_product[gen_MultivectorType_dense] = (gascalarfunc) binary_dense0_scalarproduct,
    .scalar_add[gen_MultivectorType_dense] = (gascalaraddfunc) binary_dense0_scalaradd,
    .reverse[gen_MultivectorType_dense] = (gaunaryfunc) unary_dense0_reverse,
    .ternary_product[gen_MultivectorType_dense] = (gaternaryprodfunc) ternary_dense0_product,
    .atomic_add[gen_MultivectorType_blades] = (gaatomicfunc) atomic_blades0_add,
    .atomic_product[gen_MultivectorType_blades] = (gaatomicprodfunc) atomic_blades0_product,
    .add[gen_MultivectorType_blades] = (gaaddfunc) binary_blades0_add,
    .product[gen_MultivectorType_blades] = (gaprodfunc) binary_blades0_product,
    .grade_project[gen_MultivectorType_blades] = (gaunarygradefunc) unary_blades0_gradeproject,
    .scalar_product[gen_MultivectorType_blades] = (gascalarfunc) binary_blades0_scalarproduct,
    .scalar_add[gen_MultivectorType_blades] = (gascalaraddfunc) binary_blades0_scalaradd,
    .reverse[gen_MultivectorType_blades] = (gaunaryfunc) unary_blades0_reverse,
    .ternary_product[gen_MultivectorType_blades] = (gaternaryprodfunc) ternary_blades0_product,
};

gen_Algebra gen0_algebra = {
    .math_funcs = gen0_math_funcs,
    .name = "3DVGA",
    .metric = {1,1,1,},
    .metric_size = 3,
    .iter_next[gen_MultivectorType_dense] = (gaiternextfunc) dense0_iternext,
    .init[gen_MultivectorType_dense] = (gainitfunc) dense0_init,
    .iter_next[gen_MultivectorType_blades] = (gaiternextfunc) blades0_iternext,
    .init[gen_MultivectorType_blades] = (gainitfunc) blades0_init,
}
